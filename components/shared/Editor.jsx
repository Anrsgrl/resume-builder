  ...
  return (
    <div className="relative border-gray-600 focus:outline-none focus:ring-0 focus:border-main border rounded-lg !font-[inherit]">
      <div
        ...
        } peer-focus:bg-gray-900 peer-focus:text-main  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-2 peer-placeholder-shown:top-1/2 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1`}
      >
        {label}
      </div>
      <div
